...
public class ObjectManagerJSWrapper
{
	...
	{
		return convertToJSArray(objectManager.listObjects(session, objectName, convertToJSONObject(filterData), null));
	}
	...
	{
		return convertToJSArray(objectManager.listObjects(session, objectName, uid, attributeName, convertToJSONObject(filterData), null));
	}
