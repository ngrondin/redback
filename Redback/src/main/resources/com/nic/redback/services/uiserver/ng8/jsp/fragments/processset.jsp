...
if(config.get('viewmap') != null) { %>
	rb-view-map="<%=com.nic.redback.utils.StringUtils.convertJSONToAttributeString(com.nic.redback.services.impl.RedbackUIServer.convertFilter(config.getObject('viewmap')))%>"<% 
} 
