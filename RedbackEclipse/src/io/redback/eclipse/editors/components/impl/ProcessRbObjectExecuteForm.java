...
public class ProcessRbObjectExecuteForm extends ProcessForm
{
	public ProcessRbObjectExecuteForm(DataMap d, DataList n, Manager m, Composite p, int s) 
	{
		super(d, n, m, p, s);
		createUI();
	}
	...
	public void createUI() {
		...
		new TextField(data, "function", "Function", this, SWT.NONE);
